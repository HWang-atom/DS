...
Daily Data
```{r}
datapath = "/Users/shuning/Downloads/TSFinal"
df = read.csv(file=paste(datapath,"all_days.csv",sep="/"),header=T)
df
```
Monthly Data
```{r}
df.agg = read.csv(file=paste(datapath,"agg.csv",sep="/"),header=T)
```
